...
public class StatusBarUtils {
    ...
    public static void setColor(Activity activity, @ColorInt int color, int statusBarAlpha){
        setFullScreen(activity);                                // 先设置的全屏模式
        addStatusBarBehind(activity, color, statusBarAlpha);    // 在透明状态栏的垂直下方放置一个和状态栏同样高宽的view
    }
    ...
    public static void addStatusBarBehind(Activity activity, @ColorInt int color, int statusBarAlpha) {
        ViewGroup decorView = (ViewGroup) activity.getWindow().getDecorView();  // 获取windowphone下的decorView
